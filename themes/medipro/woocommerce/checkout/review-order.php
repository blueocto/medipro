...
<div id="order_review">
	...
	<div id="payment">
		...
		<p>We hate spam as much as you do, and we take your privacy seriously. Please read our <a href="/privacy-policy/">Privacy Policy</a>. Have you read our <a href="/booking-terms/">Booking Terms</a>?</p>
		...
		<div class="place-order">
			...
			echo apply_filters( 'woocommerce_order_button_html', '<input type="submit" class="btn btn_checkoutlrg" name="woocommerce_checkout_place_order" id="place_order" value="' . esc_attr( $order_button_text ) . '" data-value="' . esc_attr( $order_button_text ) . '" />' );
			?>
